#!/usr/bin/env python3
"""YOLO-based vision detection node.

Subscribes to a camera image topic, runs YOLO inference, and publishes
annotated debug images alongside structured Detection2DArray messages.
"""
import rclpy
...
class BrickVisionNode(Node):
    ...
    def image_callback(self, msg):
        """Run YOLO inference on incoming image and publish detections."""
        try:
            ...
            for result in results:
                ...
                for box in boxes:
                    ...
                    # vision_msgs uses center.x/y and size_x/y (not x1y1x2y2)
